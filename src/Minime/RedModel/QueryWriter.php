...
class QueryWriter
{
    ...
    public function __construct($class)
    {
        ...
        $this->databaseType = $adapter->getDatabase()->getDatabaseType();
    ...
    public function limit($limit)
    {
        ...
        {
            case "oracle"; $this->where(" rownum <= $limit "); break;
            // case 'sqlserver'; $this->select(" top $limit "); break;
            default; $this->writer->addSQL(" limit $limit "); break;
        }
        return $this;
    }
    ...
    {
        return R::$toolbox->getDatabaseAdapter()->get( $sql );
    }

    public function execute($func, $adapter=null)
    {
        if(NULL === $adapter)
        {
            return R::$toolbox->getDatabaseAdapter()->exec( $func );
        }
        else
        {
            return $adapter->exec( $func );
        }
    }
}
